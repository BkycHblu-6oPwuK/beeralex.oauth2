...
2.	client_id – клиент id из таблицы yngc0der_oauth2server_clients
3.	client_secret – не захешированный client_secret из yngc0der_oauth2server_clients

Для авторизации по типу password нужно дополнительно передать еще два параметра:
1.	Здесь grant_type = “password”
2.	client_id
3.	client_secret
